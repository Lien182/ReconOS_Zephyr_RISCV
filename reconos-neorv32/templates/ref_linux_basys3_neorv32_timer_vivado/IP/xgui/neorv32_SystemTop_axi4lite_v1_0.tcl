...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "CPU_EXTENSION_RISCV_Zicsr" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "CUSTOM_ID" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "HW_THREAD_ID" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "IO_GPIO_EN" -parent ${Page_0}
...
proc update_PARAM_VALUE.CPU_EXTENSION_RISCV_Zicsr { PARAM_VALUE.CPU_EXTENSION_RISCV_Zicsr } {
	# Procedure called to update CPU_EXTENSION_RISCV_Zicsr when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.CPU_EXTENSION_RISCV_Zicsr { PARAM_VALUE.CPU_EXTENSION_RISCV_Zicsr } {
	# Procedure called to validate CPU_EXTENSION_RISCV_Zicsr
	return true
}
...
proc update_PARAM_VALUE.CUSTOM_ID { PARAM_VALUE.CUSTOM_ID } {
	# Procedure called to update CUSTOM_ID when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.CUSTOM_ID { PARAM_VALUE.CUSTOM_ID } {
	# Procedure called to validate CUSTOM_ID
	return true
}
...
proc update_PARAM_VALUE.HW_THREAD_ID { PARAM_VALUE.HW_THREAD_ID } {
	# Procedure called to update HW_THREAD_ID when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.HW_THREAD_ID { PARAM_VALUE.HW_THREAD_ID } {
	# Procedure called to validate HW_THREAD_ID
	return true
}
...
proc update_MODELPARAM_VALUE.HW_THREAD_ID { MODELPARAM_VALUE.HW_THREAD_ID PARAM_VALUE.HW_THREAD_ID } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.HW_THREAD_ID}] ${MODELPARAM_VALUE.HW_THREAD_ID}
}

proc update_MODELPARAM_VALUE.CUSTOM_ID { MODELPARAM_VALUE.CUSTOM_ID PARAM_VALUE.CUSTOM_ID } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.CUSTOM_ID}] ${MODELPARAM_VALUE.CUSTOM_ID}
}
...
proc update_MODELPARAM_VALUE.CPU_EXTENSION_RISCV_Zicsr { MODELPARAM_VALUE.CPU_EXTENSION_RISCV_Zicsr PARAM_VALUE.CPU_EXTENSION_RISCV_Zicsr } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.CPU_EXTENSION_RISCV_Zicsr}] ${MODELPARAM_VALUE.CPU_EXTENSION_RISCV_Zicsr}
}
